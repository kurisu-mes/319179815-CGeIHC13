...
void Shader::SetPointLights(PointLight * pLight, unsigned int start, unsigned int lightCount)
{
	if (lightCount > MAX_POINT_LIGHTS) lightCount = MAX_POINT_LIGHTS;

	glUniform1i(uniformPointLightCount, lightCount);

	for (size_t i = start; i < lightCount; i++)
	{
...
void Shader::SetSpotLights(SpotLight* sLight, unsigned int start, unsigned int lightCount)
{
